...
export default function FeedbackForm() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mt-4">
      <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Feedback</h3>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="feedback" className="block text-gray-700 dark:text-gray-300 mb-2">Comments</label>
          <textarea
            id="feedback"
            value={feedback}
